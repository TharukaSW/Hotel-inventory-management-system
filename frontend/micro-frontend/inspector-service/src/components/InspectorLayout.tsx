...
const InspectorLayout: React.FC<InspectorLayoutProps> = ({ children }) => {
  ...
  const navigation = [
    ...
    { name: 'New Inspection', href: '/inspections/new', icon: PlusCircle },
    { name: 'Item Requests', href: '/item-requests', icon: List },
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? 'block' : 'hidden'}`}>
        ...
        <div className="fixed inset-y-0 left-0 flex w-64 flex-col bg-white">
          <div className="flex h-16 items-center justify-between px-4">
            <h1 className="text-lg font-semibold text-gray-900">Inspector Panel</h1>
            <button
